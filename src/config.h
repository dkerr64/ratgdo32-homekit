...
public:
    ...
    int32_t read(const std::string &key, int32_t dflt);
    int32_t read(const std::string &key) { return read(key, 0); };
    std::string read(const std::string &key, const std::string &dflt);
